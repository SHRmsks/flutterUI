...
class KPContent extends StatefulWidget {
  final String title;
  ...
  @override
  _KPContentState createState() => _KPContentState();
}

class _KPContentState extends State<KPContent> {
  @override
                  ...
                  child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Image.asset('src/images/kpdetail.png'),
                            SizedBox(width: 8),
                            Text("开票详情",
                                style: TextStyle(
                                    fontSize: 14,
