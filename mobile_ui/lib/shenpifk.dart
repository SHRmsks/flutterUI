...
import "dart:convert";
import './widgets/FKcontent.dart';

class Shenpifk extends StatefulWidget {
  final String title;
  final String name;
  final String time;
  final String node;
  ...
  const Shenpifk(
      ...
      required this.token});
  @override
  _ShenpifkState createState() => _ShenpifkState();
}

class _ShenpifkState extends State<Shenpifk> {
